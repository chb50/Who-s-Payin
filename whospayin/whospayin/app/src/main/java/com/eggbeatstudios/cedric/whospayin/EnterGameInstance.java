...
//    }
    ...
    public void joinGame(View view) {
        ...
        if (selectItem()) {
            //TODO: must clear the gamesInstance list before moving to next activity
            //otherwise it will show game instances that do not exist anymore cause it wasnt cleared4
            Intent i = new Intent(this, LobbyInstance.class);
            Log.d(TAG, "print test 1");
            //TODO: need to pass the server information to the lobby activity
            startActivity(i);
        }
    }
